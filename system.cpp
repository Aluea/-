...
System::System():
    pic_now(0),rtd(0)
    {
        ...
        new_prject('m',1,600,0,0,700,350,1,1);
        new_prject('m',2,1200,0,0,700,350,1,2);
        new_prject('m',3,1800,0,0,700,350,1,3);
        ft=1;
    }
